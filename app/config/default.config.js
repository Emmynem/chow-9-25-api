...
import { 
    ...
    vendor_access_url, max_bank_accounts, max_debt, order_cancellation_percentage, vendor_cancellation_percentage, rider_cancellation_percentage, zero, verified_status
} from './config.js';
